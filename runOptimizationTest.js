...
if (typeof global.runModalOptimizationTest === 'undefined') {
  console.log('⚠️  Note: This script should be run from within the React Native app console.');
  console.log('    The automated test function is not available in this context.');
  process.exit(0);
}