...
const IconVariationsGallery: React.FC = () => {
  ...
  const needsWorkIcons = [
    { name: "🔧 WifiOff", Component: LucideIcons.WifiOff },
    { name: "🔧 Settings", Component: LucideIcons.Settings },
    { name: "🔧 Shield", Component: LucideIcons.Shield },
    { name: "🔧 Palette", Component: LucideIcons.Palette },
    { name: "🔧 Database", Component: LucideIcons.Database },
    { name: "🔧 FileCode", Component: LucideIcons.FileCode },
    { name: "🔧 TestTube2", Component: LucideIcons.TestTube2 },
    { name: "🔧 FlaskConical", Component: LucideIcons.FlaskConical },
    { name: "🔧 Box", Component: LucideIcons.Box },
    { name: "🔧 Key", Component: LucideIcons.Key },
    { name: "🔧 AlertTriangle", Component: LucideIcons.AlertTriangle },
    { name: "🔧 Eye", Component: LucideIcons.Eye },
    { name: "🔧 EyeOff", Component: LucideIcons.EyeOff },
    { name: "🔧 RefreshCw", Component: LucideIcons.RefreshCw },
