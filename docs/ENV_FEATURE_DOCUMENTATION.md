...
- **A configuration viewer** that lists all EXPO*PUBLIC*\* prefixed variables
...
5. **Expo Limitations**: Only EXPO*PUBLIC*\* prefixed vars are accessible in Expo
...
- Link to Expo documentation about EXPO*PUBLIC*\* prefix
...
5. **Expo Compatibility**: Works within Expo's EXPO*PUBLIC*\* constraints
