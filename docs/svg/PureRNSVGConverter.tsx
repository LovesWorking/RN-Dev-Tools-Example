...
export function parseSimplePath(d: string): PathSegment[] | null {
  ...
  for (const cmd of commands) {
    ...
    const args = cmd.slice(1).trim().split(/[\s,]+/).filter(a => a).map(Number);
  ...
  if (!segments) {
    return (
      <View style={{ padding: 10, backgroundColor: '#f0f0f0' }}>
        <Text style={{ fontSize: 10, color: '#666' }}>Complex path not supported</Text>
      </View>
    );
  }
...
export const AlertCircleIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    <PureCircle cx={12} cy={12} r={10} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={12} y1={8} x2={12} y2={12} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={12} y1={16} x2={12.01} y2={16} stroke={color} strokeWidth={strokeWidth} />
  </PureSvg>
);
...
export const HashIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    <PureLine x1={4} y1={9} x2={20} y2={9} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={4} y1={15} x2={20} y2={15} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={10} y1={3} x2={8} y2={21} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={16} y1={3} x2={14} y2={21} stroke={color} strokeWidth={strokeWidth} />
  </PureSvg>
);
...
export const PauseIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    <PureRect x={14} y={3} width={5} height={18} rx={1} stroke={color} strokeWidth={strokeWidth} />
    <PureRect x={5} y={3} width={5} height={18} rx={1} stroke={color} strokeWidth={strokeWidth} />
  </PureSvg>
);
...
export const WifiIconPure: React.FC<IconProps> = ({ 
  ...
  return (
    <PureSvg width={size} height={size} viewBox="0 0 24 24">
      ...
      {/* Outer wave */}
      <PurePath d="M2 8.82a15 15 0 0 1 20 0" stroke={color} strokeWidth={strokeWidth} />
      {/* Middle wave */}
      <PurePath d="M5 12.859a10 10 0 0 1 14 0" stroke={color} strokeWidth={strokeWidth} />
      {/* Inner wave */}
      <PurePath d="M8.5 16.429a5 5 0 0 1 7 0" stroke={color} strokeWidth={strokeWidth} />
      {/* Signal dot */}
      <PureCircle cx={12} cy={20} r={0.5} fill={color} stroke={color} strokeWidth={0} />
    </PureSvg>
  );
};
...
export const WifiOffIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    {/* WiFi waves (partial) */}
    <PurePath d="M8.5 16.429a5 5 0 0 1 7 0" stroke={color} strokeWidth={strokeWidth} />
    <PurePath d="M5 12.859a10 10 0 0 1 5.17-2.69" stroke={color} strokeWidth={strokeWidth} />
    <PurePath d="M19 12.859a10 10 0 0 0-2.007-1.523" stroke={color} strokeWidth={strokeWidth} />
    {/* Signal dot */}
    <PureCircle cx={12} cy={20} r={0.5} fill={color} stroke={color} strokeWidth={0} />
    {/* Slash line */}
...
export const DatabaseIconPure: React.FC<IconProps> = ({ 
  ...
  return (
    <PureSvg width={size} height={size} viewBox="0 0 24 24">
      ...
      {/* Middle section */}
      <PureLine x1={3} y1={8} x2={3} y2={16} stroke={color} strokeWidth={strokeWidth} />
      <PureLine x1={21} y1={8} x2={21} y2={16} stroke={color} strokeWidth={strokeWidth} />
      {/* Middle ellipse */}
      <View style={{
        position: 'absolute',
        left: 3 * scale,
      ...
      {/* Bottom section */}
      <PureLine x1={3} y1={15} x2={3} y2={19} stroke={color} strokeWidth={strokeWidth} />
      <PureLine x1={21} y1={15} x2={21} y2={19} stroke={color} strokeWidth={strokeWidth} />
      {/* Bottom curve */}
      <View style={{
        position: 'absolute',
        left: 3 * scale,
...
export const ServerIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    {/* Top server unit */}
    <PureRect x={2} y={2} width={20} height={8} rx={2} stroke={color} strokeWidth={strokeWidth} />
    {/* Bottom server unit */}
    <PureRect x={2} y={14} width={20} height={8} rx={2} stroke={color} strokeWidth={strokeWidth} />
...
export const HardDriveIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    ...
    <PureRect x={2} y={4} width={20} height={16} rx={2} stroke={color} strokeWidth={strokeWidth} />
    {/* Divider line */}
    <PureLine x1={2} y1={12} x2={22} y2={12} stroke={color} strokeWidth={strokeWidth} />
    {/* Status indicators */}
...
export const ShieldIconPure: React.FC<IconProps> = ({ 
  ...
  return (
    <PureSvg width={size} height={size} viewBox="0 0 24 24">
      ...
      {/* Top edges */}
      <PureLine x1={12} y1={2} x2={4} y2={6} stroke={color} strokeWidth={strokeWidth} />
      <PureLine x1={12} y1={2} x2={20} y2={6} stroke={color} strokeWidth={strokeWidth} />
      {/* Side edges */}
      <PureLine x1={4} y1={6} x2={4} y2={13} stroke={color} strokeWidth={strokeWidth} />
      <PureLine x1={20} y1={6} x2={20} y2={13} stroke={color} strokeWidth={strokeWidth} />
      {/* Bottom point */}
      <PureLine x1={4} y1={13} x2={12} y2={22} stroke={color} strokeWidth={strokeWidth} />
      <PureLine x1={20} y1={13} x2={12} y2={22} stroke={color} strokeWidth={strokeWidth} />
    </PureSvg>
  );
};
...
export const NetworkIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    ...
    <PureCircle cx={19} cy={19} r={2} stroke={color} strokeWidth={strokeWidth} />
    {/* Connection lines */}
    <PureLine x1={12} y1={12} x2={5} y2={5} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={12} y1={12} x2={19} y2={5} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={12} y1={12} x2={5} y2={19} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={12} y1={12} x2={19} y2={19} stroke={color} strokeWidth={strokeWidth} />
  </PureSvg>
);
...
export const EnvIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    ...
    <PureLine x1={12} y1={2} x2={19} y2={6} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={19} y1={6} x2={19} y2={14} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={19} y1={14} x2={12} y2={18} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={12} y1={18} x2={5} y2={14} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={5} y1={14} x2={5} y2={6} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={5} y1={6} x2={12} y2={2} stroke={color} strokeWidth={strokeWidth} />
    {/* Center circle */}
    <PureCircle cx={12} cy={10} r={3} stroke={color} strokeWidth={strokeWidth} />
  </PureSvg>
);
...
export const StorageIconPure: React.FC<IconProps> = ({ 
  ...
  <PureSvg width={size} height={size} viewBox="0 0 24 24">
    {/* Storage drawers */}
    <PureRect x={3} y={2} width={18} height={6} stroke={color} strokeWidth={strokeWidth} />
    <PureRect x={3} y={9} width={18} height={6} stroke={color} strokeWidth={strokeWidth} />
    <PureRect x={3} y={16} width={18} height={6} stroke={color} strokeWidth={strokeWidth} />
    {/* Drawer handles */}
    <PureLine x1={10} y1={5} x2={14} y2={5} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={10} y1={12} x2={14} y2={12} stroke={color} strokeWidth={strokeWidth} />
    <PureLine x1={10} y1={19} x2={14} y2={19} stroke={color} strokeWidth={strokeWidth} />
  </PureSvg>
);
...
export const PureRNSVGDemo: React.FC = () => {
  return (
    <View style={{ flex: 1, padding: 20, backgroundColor: '#f5f5f5' }}>
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 20, marginBottom: 30 }}>
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 15 }}>
        {Object.keys(PURE_RN_ICONS).map(name => (
          <View key={name} style={{ alignItems: 'center', width: 60 }}>
            ...
            <Text style={{ fontSize: 9, marginTop: 4, textAlign: 'center' }}>{name}</Text>
          </View>
        ))}
      </View>
    </View>
