    ...
    return (
      <>
        ...
        {!options.hideLineNumbers && (
          ...
          >
            <Text style={dynamicStyles.lineNumber}>
              {lineNumber || " "}
            </Text>
          </View>
        )}
        ...
        {/* Change marker */}
        <View style={[dynamicStyles.marker, { backgroundColor: colors.markerBg }]}>
        ...
        {/* Content */}
        <View style={[dynamicStyles.contentCell, { backgroundColor: colors.background }]}>
    ...
    <View style={[dynamicStyles.container, theme.glowColor && {
      ...
      <View style={dynamicStyles.summaryBar}>
        <View style={dynamicStyles.summaryItem}>
          <Text style={[dynamicStyles.summaryText, { color: theme.summaryAddedText }]}>
            +{lineDiffs.filter((d) => d.type === DiffType.ADDED).length}
          </Text>
        </View>
        <View style={dynamicStyles.summaryItem}>
          <Text style={[dynamicStyles.summaryText, { color: theme.summaryRemovedText }]}>
            -{lineDiffs.filter((d) => d.type === DiffType.REMOVED).length}
          </Text>
        </View>
        <View style={dynamicStyles.summaryItem}>
          <Text style={[dynamicStyles.summaryText, { color: theme.summaryModifiedText }]}>
