...
import { FileCode, Layers, FileText, GitBranch } from 'rn-better-dev-tools/icons';
...
export function DiffModeSelector({ currentMode, onModeChange, changeCount }: DiffModeSelectorProps) {
  return (
