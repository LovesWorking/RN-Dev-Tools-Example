...
import { Database, Shield, AlertCircle, CheckCircle2, XCircle, Eye, Zap } from "../icons";
...
export function GameUIStorageStats({ stats }: GameUIStorageStatsProps) {
  ...
  const healthPercentage =
    requiredTotal > 0 ? Math.round((presentRequiredCount / requiredTotal) * 100) : 100;
    ...
    return (
      <View style={styles.mainPanel}>
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtitle}>Your app has not saved any data yet</Text>
        </View>
      </View>
    );
  }
    ...
    <View style={styles.mainPanel}>
      ...
      <View style={styles.healthSection}>
        <View style={styles.healthHeader}>
          ...
          <Text style={[styles.healthPercentage, { color: healthColor }]}>{healthPercentage}%</Text>
        </View>
      ...
      <View style={styles.statsGrid}>
        {storageTypeData.map((item) => {
          ...
          const isError =
            item.key === "missing" || item.key === "wrongValue" || item.key === "wrongType";
          ...
          return (
            ...
            >
              ...
              {/* Corner indicators */}
              <View
                style={[styles.cornerIndicator, styles.cornerTL, { backgroundColor: item.color }]}
              />
              <View
                style={[styles.cornerIndicator, styles.cornerBR, { backgroundColor: item.color }]}
              />
            </Animated.View>
          );
        })}
              ...
              return (
                <View key={backend.key} style={styles.backendItem}>
                  ...
                  <View style={styles.backendStats}>
                    <Text style={[styles.backendCount, { color: backend.color }]}>{count}</Text>
