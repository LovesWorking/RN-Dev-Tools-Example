...
import { Settings, Hash, FileText, Filter } from "../../icons";
...
export function DiffOptionsPanel({
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.toggleButton} onPress={onToggleExpanded} activeOpacity={0.7}>
            ...
            <View style={styles.optionContainer}>
              <View style={styles.option}>
                ...
                <Switch
                  ...
                  thumbColor={
                    !options.hideLineNumbers ? macOSColors.semantic.success : macOSColors.text.muted
                  }
                  style={styles.switch}
                />
              </View>
            ...
            <View style={styles.optionContainer}>
              <View style={styles.option}>
                ...
                <Switch
                  ...
                  thumbColor={
                    !options.disableWordDiff ? macOSColors.semantic.success : macOSColors.text.muted
                  }
                  style={styles.switch}
                />
              </View>
            ...
            <View style={styles.optionContainer}>
              <View style={styles.option}>
                ...
                <Switch
                  ...
                  thumbColor={
                    options.showDiffOnly ? macOSColors.semantic.success : macOSColors.text.muted
                  }
                  style={styles.switch}
                />
              </View>
