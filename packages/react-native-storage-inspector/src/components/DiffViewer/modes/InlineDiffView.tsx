...
import { Plus, Minus, Edit3, ChevronDown, ChevronRight } from "../../../icons";
...
export function InlineDiffView({ newValue, differences, debugMode }: InlineDiffViewProps) {
              ...
              <View key={pathStr} style={styles.changeItem}>
                ...
                {isExpanded && (
                  <View style={styles.expandedContent}>
                      ...
                      <>
                        ...
                        <View style={styles.valueContainer}>
                          {typeof diff.value === "object" && diff.value !== null ? (
                            ...
                            <Text style={styles.primitiveValue}>{JSON.stringify(diff.value)}</Text>
                          )}
                        </View>
                      </>
                    )}
                    {diff.type === "CREATE" && (
                      <>
                        <Text style={[styles.valueLabel, { color: macOSColors.semantic.success }]}>
                          ADDED:
                        </Text>
                        <View style={styles.valueContainer}>
                          {typeof diff.value === "object" && diff.value !== null ? (
                    ...
                    {diff.type === "REMOVE" && (
                      <>
                        <Text style={[styles.valueLabel, { color: macOSColors.semantic.error }]}>
                          REMOVED:
                        </Text>
                        <View style={styles.valueContainer}>
                          {typeof diff.oldValue === "object" && diff.oldValue !== null ? (
