...
import { ChevronLeft, ChevronRight, AlertCircle, X, Database, GitBranch } from "../icons";
...
export function StorageEventDetailContent({
  ...
  const [internalActiveView, setInternalActiveView] = useState<"current" | "diff">("current");
        ...
        <View style={styles.valueBox}>
          {type === "object" || type === "array" ? (
            ...
            ((Array.isArray(parsed) && parsed.length > 0) ||
              ...
              <DataViewer data={parsed} />
            ) : (
              <Text style={styles.valueText}>{type === "array" ? "[]" : "{}"}</Text>
            )
          ) : (
  ...
  const renderCurrentValue = () => {
    ...
    return (
      <View style={styles.fullPageSection}>
        <View style={styles.contentCard}>{renderValueContent(valueToShow, "CURRENT VALUE")}</View>
      </View>
    );
  };
        ...
        {totalEvents > 0 && (
          <View style={styles.compareBar}>
            ...
            <View style={styles.compareSide}>
              <Text style={[styles.compareLabel, { color: macOSColors.semantic.debug }]}>PREV</Text>
            ...
            <View style={styles.viewToggleContent}>
              ...
              <Text
                style={[
                  ...
                  internalActiveView === "current" && styles.viewToggleLabelActive,
                ]}
              >
                CURRENT VALUE
              </Text>
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      isSelected && isLeftPickerOpen && styles.pickerItemSelectedLeft,
                      isSelected && isRightPickerOpen && styles.pickerItemSelectedRight,
      ...
      {totalEvents > 1 && !disableInternalFooter && (
        <View style={styles.stickyFooter}>
          ...
          >
            <ChevronLeft
              size={20}
              color={selectedEventIndex === 0 ? macOSColors.text.muted : macOSColors.text.primary}
            />
            <Text
              style={[
