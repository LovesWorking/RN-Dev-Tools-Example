...
import { AlertCircle, CheckCircle2, Eye, XCircle, HardDrive, Database, Shield } from "../icons";
import { StorageKeyInfo } from "../types";
import {
  getStorageTypeLabel,
  getStorageTypeHexColor,
} from "../external/react-query/utils/storageQueryUtils";
 ...
 */
export function StorageKeyCard({ storageKey, isExpanded, onToggle }: StorageKeyCardProps) {
        ...
        <View style={styles.cardHeaderLeft}>
          ...
          <View style={styles.cardHeaderInfo}>
            ...
            <View style={styles.cardHeaderMeta}>
              ...
              <View style={[styles.storageBadge, { backgroundColor: `${storageTypeColor}15` }]}>
              ...
              {hasValue && (
                <View style={styles.valueBadge}>
                  <Text style={styles.valueText}>{getEnvVarType(storageKey.value)}</Text>
                </View>
              )}
            </View>
          </View>
          ...
          <View style={styles.dataViewerContainer}>
            ...
            typeof storageKey.value === "boolean" ? (
              <View style={styles.simpleValueContainer}>
                ...
                <Text style={styles.valueTypeText}>Type: {getEnvVarType(storageKey.value)}</Text>
              </View>
            ) : (
              <DataViewer data={storageKey.value} />
            )}
          </View>
      ...
      {isExpanded && !hasValue && (
        <View style={styles.cardBody}>
          <View style={styles.emptyValueContainer}>
            ...
            <Text style={styles.emptyValueText}>Storage key not found or empty</Text>
          </View>
