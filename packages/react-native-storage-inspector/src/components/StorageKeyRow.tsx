...
export function StorageKeyRow({ storageKey, isExpanded, onPress }: StorageKeyRowProps) {
  ...
  const expandedContent = (
    <View style={styles.expandedContainer}>
      ...
      {storageKey.status === "required_wrong_value" && storageKey.expectedValue && (
        <View style={styles.expandedRow}>
          <Text style={styles.expandedLabel}>Expected:</Text>
          <Text style={styles.expandedExpected}>{String(storageKey.expectedValue)}</Text>
        </View>
      )}
      {storageKey.description && (
        <View style={styles.expandedRow}>
          <Text style={styles.expandedLabel}>Info:</Text>
          <Text style={styles.expandedDescription}>{storageKey.description}</Text>
        </View>
      )}
    </View>
  );
  ...
  const storageBadge = (
    ...
    >
      <Text
        style={[styles.storageBadgeText, { color: getStorageTypeColor(storageKey.storageType) }]}
      >
        {storageTypeLabel}
      </Text>
    </View>
