...
import { AlertCircle, CheckCircle2, XCircle, Eye, Database, Shield } from "../icons";
                ...
                <View style={styles.breakdownItemRow}>
                  <View style={styles.breakdownItemLeft}>
                    ...
                    <View style={styles.breakdownItemInfo}>
                      ...
                      <Text style={styles.breakdownItemDesc}>{item.description}</Text>
                    </View>
                  </View>
                  <View style={styles.breakdownItemRight}>
                    <Text style={[styles.breakdownCount, { color: item.textColor }]}>{count}</Text>
        ...
        <View style={styles.breakdownSection}>
          ...
          <View style={styles.breakdownList}>
            {storageTypeData.map((item) => {
              ...
              const percentage = totalCount > 0 ? ((count / totalCount) * 100).toFixed(1) : "0";
              const IconComponent = item.icon;
              const storageColor = getStorageTypeHexColor(item.key as StorageType);
              ...
              return (
                <View key={item.key} style={styles.breakdownItem}>
                  <View style={styles.breakdownItemRow}>
                    <View style={styles.breakdownItemLeft}>
                      <View
                        style={[styles.breakdownIcon, { backgroundColor: `${storageColor}15` }]}
                      >
                    ...
                    <View style={styles.breakdownItemRight}>
                      <Text style={[styles.breakdownCount, { color: storageColor }]}>{count}</Text>
                      <Text style={styles.breakdownPercentage}>{percentage}%</Text>
                    </View>
                  </View>
                </View>
