...
export function AddFilterButton({ onPress, color = "#E5E7EB" }: AddFilterButtonProps) {
  return (
    <TouchableOpacity style={[styles.addButton, { borderColor: `${color}40` }]} onPress={onPress}>
...
export function FilterList({ filters, onRemoveFilter, color = "#E5E7EB" }: FilterListProps) {
